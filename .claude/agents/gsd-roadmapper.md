...
Reference full template: `/home/tamer/AICouseProjects/finally/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/tamer/AICouseProjects/finally/.claude/gsd-core/templates/state.md`.
