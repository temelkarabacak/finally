...
**Verification depth scales with `asvs_level`** (see @/home/tamer/AICouseProjects/finally/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
