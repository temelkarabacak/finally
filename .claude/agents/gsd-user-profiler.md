...
<reference>
@/home/tamer/AICouseProjects/finally/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/home/tamer/AICouseProjects/finally/.claude/gsd-core/references/user-profiling.md` to load:
