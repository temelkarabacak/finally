...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/tamer/AICouseProjects/finally/.claude/.gsd-surface.json`
(sibling to `/home/tamer/AICouseProjects/finally/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/tamer/AICouseProjects/finally/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/tamer/AICouseProjects/finally/.claude/skills`).
...
`/home/tamer/AICouseProjects/finally/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/tamer/AICouseProjects/finally/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/tamer/AICouseProjects/finally/.claude/.gsd-surface.json`
Install profile marker: `/home/tamer/AICouseProjects/finally/.claude/.gsd-profile`
Skill dirs: `/home/tamer/AICouseProjects/finally/.claude/skills/gsd-*/`
Engine module: `/home/tamer/AICouseProjects/finally/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/tamer/AICouseProjects/finally/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
