...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/tamer/AICouseProjects/finally/.claude
                  → checks /home/tamer/AICouseProjects/finally/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/tamer/AICouseProjects/finally/.claude/gsd-core
                  → writes to /home/tamer/AICouseProjects/finally/.claude/gsd-core/hooks/
