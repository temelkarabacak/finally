...
Read and follow `/home/tamer/AICouseProjects/finally/.claude/gsd-core/workflows/transition.md`, passing through the `--auto` flag so it propagates to the next phase invocation.
