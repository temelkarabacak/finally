...
<!-- For checkpoint task examples and patterns, see @/home/tamer/AICouseProjects/finally/.claude/gsd-core/references/checkpoints.md -->
...
See `/home/tamer/AICouseProjects/finally/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/home/tamer/AICouseProjects/finally/.claude/gsd-core/templates/user-setup.md` for full schema and examples
