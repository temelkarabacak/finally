...
ones). Reference: @/home/tamer/AICouseProjects/finally/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /home/tamer/AICouseProjects/finally/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/home/tamer/AICouseProjects/finally/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/home/tamer/AICouseProjects/finally/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/home/tamer/AICouseProjects/finally/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/home/tamer/AICouseProjects/finally/.claude/gsd-core/templates/spec.md.
