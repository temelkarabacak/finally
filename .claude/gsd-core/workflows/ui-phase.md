...
```markdown
Read /home/tamer/AICouseProjects/finally/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/tamer/AICouseProjects/finally/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/tamer/AICouseProjects/finally/.claude/agents/gsd-ui-checker.md for instructions.
...
@/home/tamer/AICouseProjects/finally/.claude/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /home/tamer/AICouseProjects/finally/.claude.
...
UI_PROBE_JS=$(for _c in \
  ...
  "/home/tamer/AICouseProjects/finally/.claude/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/home/tamer/AICouseProjects/finally/.claude/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
